...
public class NongYe_HomeRecyl_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<String> isLoad = new ArrayList<>();
     ...
     * @param date 数据
     */
    public NongYe_HomeRecyl_Adapter(Map<Integer, Object> date, Fragment fragment) {
        ...
        switch (position) {
            ...
            default://爱吃item
                if (mDates.containsKey(5)) {
                    ...
                    mEatItem.setData((NY_EatItemModel) mDates.get(5), mFragment, position);
                }
                break;
        }
    }
