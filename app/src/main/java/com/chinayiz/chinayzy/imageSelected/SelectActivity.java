package com.chinayiz.chinayzy.imageSelected;
...
import com.chinayiz.chinayzy.imageSelected.model.UploadGoodsBean;
import com.chinayiz.chinayzy.imageSelected.util.Config;
import com.chinayiz.chinayzy.imageSelected.util.DbTOPxUtil;
	...
	public class GridImgAdapter extends BaseAdapter implements ListAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (img_uri.get(position) == null) {
				...
				ImageLoader.getInstance().displayImage("drawable://" + R.mipmap.img_add_image, add_IB);
...
//						FileUtils.DeleteFolder(img_url);
				...
				add_IB.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						CommonUtils.launchActivity(SelectActivity.this, PhotoPreviewActivity.class, bundle);
					}
				});
