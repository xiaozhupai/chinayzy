...
public class ShopCartFragment extends BaseFragment<ShopCartPresenter> implements View.OnClickListener {
    ...
    public View initView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       final NongYe_MainActivity activity= (NongYe_MainActivity) getActivity();
        ...
        adaphter=new ShopCartAdaphter(mContext,list,iv_shopcart_radio,tv_shopcart_price,tv_shopcart_all,0);
