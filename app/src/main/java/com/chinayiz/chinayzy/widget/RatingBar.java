...
public class RatingBar extends LinearLayout {
    ...
    public RatingBar(Context context, AttributeSet attrs) {
        ...
        starHalfDrawable = mTypedArray.getDrawable(com.hedgehog.ratingbar.R.styleable.RatingBar_starHalf);
        starEmptyDrawable = mTypedArray.getDrawable(com.hedgehog.ratingbar.R.styleable.RatingBar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(com.hedgehog.ratingbar.R.styleable.RatingBar_starFill);
        starImageSize = mTypedArray.getDimension(com.hedgehog.ratingbar.R.styleable.RatingBar_starImageSize, 120);
        starImageWidth = mTypedArray.getDimension(com.hedgehog.ratingbar.R.styleable.RatingBar_starImageWidth, 60);
        starImageHeight = mTypedArray.getDimension(com.hedgehog.ratingbar.R.styleable.RatingBar_starImageHeight, 120);
        starImagePadding = mTypedArray.getDimension(com.hedgehog.ratingbar.R.styleable.RatingBar_starImagePadding, 15);
        starCount = mTypedArray.getInteger(com.hedgehog.ratingbar.R.styleable.RatingBar_starCount, 5);
        starNum = mTypedArray.getInteger(com.hedgehog.ratingbar.R.styleable.RatingBar_starNum, 0);
        mClickable = mTypedArray.getBoolean(com.hedgehog.ratingbar.R.styleable.RatingBar_clickable, true);
        halfstart = mTypedArray.getBoolean(com.hedgehog.ratingbar.R.styleable.RatingBar_halfstart, false);
