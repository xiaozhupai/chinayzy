...
//		}.sendEmptyMessageDelayed(0, 1000);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        try {
            int sum = (int) (pullDownY + pullUpY);
            int top = sum - refreshView.getMeasuredHeight();
            ...
            loadmoreView.layout(0, bottom, loadmoreView.getMeasuredWidth(), sum + loadmoreView.getMeasuredHeight());
